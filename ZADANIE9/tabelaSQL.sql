...
SELECT tabelageol.GeoPietro.id_pietro,tabelageol.GeoPietro.nazwa_pietro, tabelageol.GeoEpoka.id_epoka,
tabelageol.GeoEpoka.nazwa_epoka, tabelageol.GeoOkres.id_okres,tabelageol.GeoOkres.nazwa_okres
,tabelageol.GeoEra.id_era,tabelageol.GeoEra.nazwa_era, tabelageol.GeoEon.id_eon, tabelageol.GeoEon.nazwa_eon
INTO GeoTabela FROM (tabelageol.GeoPietro INNER JOIN 
tabelageol.GeoEpoka ON tabelageol.GeoPietro.id_epoka=tabelageol.GeoEpoka.id_epoka
INNER JOIN tabelageol.GeoOkres ON tabelageol.GeoEpoka.id_okres=tabelageol.GeoOkres.id_okres INNER JOIN tabelageol.GeoEra 
ON tabelageol.GeoOkres.id_era=tabelageol.GeoEra.id_era
INNER JOIN tabelageol.GeoEon ON   tabelageol.GeoEra.id_eon=tabelageol.GeoEon.id_eon);

ALTER TABLE GeoTabela ADD PRIMARY KEY (id_pietro);
ALTER TABLE GeoTabela DROP PRIMARY KEY;
...
CREATE NONCLUSTERED INDEX mil ON Milion (liczba);    
...
-- bez nałożonych indeksów na kolumny danych:
SELECT COUNT(*) FROM Milion INNER JOIN tabelageol.GeoPietro ON 
((Milion.liczba%68)=tabelageol.GeoPietro.id_pietro) INNER JOIN tabelageol.GeoEpoka 
ON tabelageol.GeoPietro.id_epoka=tabelageol.GeoEpoka.id_epoka
INNER JOIN tabelageol.GeoOkres ON
tabelageol.GeoEpoka.id_okres=tabelageol.GeoOkres.id_okres
INNER JOIN tabelageol.GeoEra ON
tabelageol.GeoOkres.id_era=tabelageol.GeoEra.id_era
INNER JOIN tabelageol.GeoEon ON
tabelageol.GeoEra.id_eon=tabelageol.GeoEon.id_eon;


--z indeksami na wszystkich kolumnach biorących udział w złączeniu:
CREATE INDEX mil ON Milion (liczba);    
...
--z indeksami na wszystkich kolumnach biorących udział w złączeniu:
CREATE CLUSTERED INDEX mil ON Milion (liczba);    
...
(SELECT tabelageol.GeoPietro.id_pietro FROM tabelageol.GeoPietro 
 INNER JOIN tabelageol.GeoEpoka ON tabelageol.GeoPietro.id_epoka=tabelageol.GeoEpoka.id_epoka
 INNER JOIN tabelageol.GeoOkres ON tabelageol.GeoEpoka.id_okres=tabelageol.GeoOkres.id_okres
 INNER JOIN tabelageol.GeoEra  ON tabelageol.GeoOkres.id_era=tabelageol.GeoEra.id_era
 INNER JOIN tabelageol.GeoEon ON tabelageol.GeoEra.id_eon=tabelageol.GeoEon.id_eon);
